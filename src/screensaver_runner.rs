    ...
    fn enable() -> Option<Self> {
        unsafe {
            ...
            if !hwnd.is_null() {
                ...
                SetWindowPos(hwnd, std::ptr::null_mut(), 0, 0, width, height, 0x0020 | 0x0040); // SWP_FRAMECHANGED | SWP_SHOWWINDOW
    ...
    fn drop(&mut self) {
        unsafe {
            ...
            if !self.hwnd.is_null() {
                ...
                SetWindowPos(self.hwnd, std::ptr::null_mut(), x, y, w, h, 0x0020 | 0x0040); // SWP_FRAMECHANGED | SWP_SHOWWINDOW
            }
