...
#[cfg(feature = "service")]
#[allow(deprecated)] // Intentional: Re-exporting legacy query_windows_service_status for backward compatibility with older apps
pub use service::{
...
#[cfg(feature = "event-log")]
#[allow(deprecated)] // Intentional: Re-exporting legacy log_windows_event for backward compatibility with older apps
pub use event_log::{
