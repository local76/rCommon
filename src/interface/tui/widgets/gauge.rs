...
/// let is_focused = true;
/// let gauge = AccentGauge::new_with_colors(
///     0.65,
///     "Battery Charge",
///     &colors,
///     true, // Use Unicode symbols
///     is_focused,
/// );
/// ```
#[derive(Debug, Clone)]
...
mod tests {
    ...
    #[test]
    fn test_accent_gauge_focused() {
        let colors = AccentColors::new(Color::Green, Color::DarkGray, Color::White);
        let gauge = AccentGauge::new_with_colors(0.5, "Test", &colors, true, true);
        assert!(gauge.focused);
        assert_eq!(gauge.accent_color, Color::Green);
    }
}
